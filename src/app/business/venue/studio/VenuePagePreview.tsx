...
function VenuePreviewContent(props: VenuePagePreviewProps) {
  ...
  switch (layout) {
    ...
    case 'boarding-pass':
    default:              return <CommunityVenuePreview {...props} />
  }
}

// ─── Main export: scaled phone frame ─────────────────────────────────────────

export default function VenuePagePreview(props: VenuePagePreviewProps) {
