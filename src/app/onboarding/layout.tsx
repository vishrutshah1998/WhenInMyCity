...
const STEP_MAP: Record<string, { total: number; current: number }> = {
  ...
  '/onboarding/explorer/E2': { total: 5, current: 1 },
  '/onboarding/explorer/E4': { total: 5, current: 2 },
  '/onboarding/explorer/E5': { total: 5, current: 3 },
  '/onboarding/explorer/E6': { total: 5, current: 4 },
  '/onboarding/explorer/E7': { total: 5, current: 5 },
