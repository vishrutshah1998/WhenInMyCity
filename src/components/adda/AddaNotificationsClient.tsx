...
import { markAddaNotificationRead, markAllAddaNotificationsRead } from '@/app/actions/adda-notifications'
...
export function AddaNotificationsClient({ notifications: initial, unreadCount: initialUnread }: Props) {
