...
import { reactToCommunityPost } from '@/app/actions/communities'

// Visually identical to ReactionBar.tsx (same 5-emoji set, same pill
// styling) but pointed at community_post_reactions/community_post_id —
// creator posts and community posts are different domains that happen to
// look the same. Do not modify ReactionBar.tsx to generalize this; keep
// them separate.
