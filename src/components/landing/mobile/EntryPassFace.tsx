  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
        <ScaleToFit>
          <div style={{ padding: '16px 18px 4px 20px', position: 'relative' }}>
            ...
            {/* Watermark stamp — in-flow, below all text so it never overlaps/dims readability */}
            <div aria-hidden style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 10 }}>
              <Image src="/logo-stamp.png" alt="" width={80} height={80} priority style={{ width: 80, height: 80, opacity: 0.4 }} />
            </div>
          </div>
        </ScaleToFit>
      </div>
