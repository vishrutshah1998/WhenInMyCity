...
import type { BenchmarkMetric } from '@/lib/venue/mock/analyticsData'
    ...
    >
      ...
      {!venueTierSufficient && (
        <div style={{
          ...
          Upgrade your Venue to <strong style={{ color: 'var(--venue-text-secondary)' }}>Nukkad tier</strong> to unlock
