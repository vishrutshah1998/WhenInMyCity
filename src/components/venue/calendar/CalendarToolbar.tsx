      ...
      <div style={{
        ...
        {viewList.map((v) => (
          <button
            ...
            style={{
              padding: '6px 14px',
              background: view === v ? 'var(--venue-amber)' : 'transparent',
              color: view === v ? '#000' : 'var(--venue-text-secondary)',
              border: 'none',
              borderRight: v !== viewList[viewList.length - 1] ? '1px solid var(--venue-border-default)' : 'none',
              fontFamily: 'var(--font-inter), system-ui, sans-serif',
              fontSize: 12.5,
