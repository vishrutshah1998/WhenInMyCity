...
export const CREATOR_CATEGORIES: CategoryConfig[] = [
  {
    ...
    subTypes: [
      { id: 'live_concerts',    label: 'Live concerts & shows' },
      { id: 'acoustic_sets',    label: 'Acoustic / unplugged sets' },
      { id: 'dj_nights',        label: 'DJ nights & sets' },
      { id: 'open_mic_jams',    label: 'Open mics & jam sessions' },
      { id: 'music_workshops',  label: 'Music workshops & classes' },
      { id: 'album_launches',   label: 'Album / EP launch events' },
      { id: 'sufi_classical',   label: 'Sufi, Ghazal & classical nights' },
      { id: 'college_corporate',label: 'College fest & corporate shows' },
      { id: 'not_yet',          label: 'Not hosting events yet' },
    ],
    suggestedPlatforms: [
  ...
  },
  {
    ...
    subTypes: [
      ...
      { id: 'open_mics',           label: 'Open mics' },
      { id: 'theatre_productions', label: 'Theatre productions' },
      { id: 'improv_sketch',       label: 'Improv & sketch nights' },
      { id: 'storytelling_poetry', label: 'Storytelling & poetry nights' },
      { id: 'comedy_workshops',    label: 'Comedy workshops' },
      { id: 'corporate_private',   label: 'Corporate & private shows' },
      { id: 'not_yet',             label: 'Not hosting events yet' },
    ],
    suggestedPlatforms: [
      { id: 'instagram', label: 'Instagram', placeholder: '@yourhandle' },
  ...
  },
  {
    ...
    subTypes: [
      ...
      { id: 'live_painting',    label: 'Live painting & sketching' },
      { id: 'photo_walks',      label: 'Photography walks & tours' },
      { id: 'art_workshops',    label: 'Workshops & art classes' },
      { id: 'popup_stalls',     label: 'Pop-up stalls & art markets' },
      { id: 'portfolio_shows',  label: 'Portfolio showcases & critiques' },
  ...
  },
  {
    ...
    subTypes: [
      { id: 'fan_meetups',        label: 'Fan meetups & community events' },
      { id: 'watch_parties',      label: 'Watch parties & screenings' },
      { id: 'live_qa',            label: 'Live Q&A sessions' },
      { id: 'creator_collabs',    label: 'In-person creator collabs' },
      { id: 'content_workshops',  label: 'Content creation workshops' },
      { id: 'live_podcast',       label: 'Live podcast recordings' },
      { id: 'brand_activations',  label: 'Brand events & activations' },
      { id: 'not_yet',            label: 'Not hosting events yet' },
    ],
    suggestedPlatforms: [
      { id: 'instagram', label: 'Instagram', placeholder: '@yourhandle' },
  ...
  },
  {
    ...
    subTypes: [
      { id: 'workshops_masterclass', label: 'Workshops & masterclasses' },
      { id: 'group_coaching',        label: 'Group coaching sessions' },
      { id: 'bootcamps',             label: 'Bootcamps & intensives' },
      { id: 'seminars_talks',        label: 'Seminars & open talks' },
      { id: 'demo_days',             label: 'Demo days & showcases' },
      { id: 'study_circles',         label: 'Study circles & reading groups' },
  ...
  },
  {
    ...
    subTypes: [
      { id: 'fitness_yoga',      label: 'Fitness classes & yoga sessions' },
      { id: 'cooking_workshops', label: 'Cooking & food workshops' },
      { id: 'food_walks',        label: 'Tasting events & food walks' },
      { id: 'styling_sessions',  label: 'Fashion & styling sessions' },
      { id: 'wellness_circles',  label: 'Wellness & meditation circles' },
      { id: 'group_treks',       label: 'Group treks & travel experiences' },
      { id: 'city_walks',        label: 'City walks & community runs' },
      { id: 'not_yet',           label: 'Not hosting events yet' },
    ],
    suggestedPlatforms: [
      { id: 'instagram', label: 'Instagram', placeholder: '@yourhandle' },
  ...
  },
  {
    ...
    subTypes: [
      { id: 'speaking_talks',    label: 'Speaking engagements & talks' },
      { id: 'networking_events', label: 'Networking events' },
      { id: 'portfolio_reviews', label: 'Portfolio reviews & critiques' },
      { id: 'skill_workshops',   label: 'Workshops & skill-shares' },
      { id: 'panel_conferences', label: 'Panel discussions & conferences' },
  ...
  },
  {
    ...
    subTypes: [
      ...
      { id: 'town_halls',          label: 'Open door sessions & town halls' },
      { id: 'not_yet',             label: 'Not hosting events yet' },
    ],
    suggestedPlatforms: [
      { id: 'instagram', label: 'Instagram', placeholder: '@yourhandle' },
